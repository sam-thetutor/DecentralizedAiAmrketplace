...
import { idlFactory } from './backend2.did.js';
export { idlFactory } from './backend2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BACKEND2;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./backend2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the backend2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./backend2.did.js")._SERVICE>}
 */
export const backend2 = createActor(canisterId);
